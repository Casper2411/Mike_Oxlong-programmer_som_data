...
# 1 "./Assignement2/HelloLex/hello2.fsl"
  // starting
...
# 9 "./Assignement2/HelloLex/hello2.fs"
...
and Tokenize  lexbuf =
  ...
  | 0 -> ( 
# 9 "./Assignement2/HelloLex/hello2.fsl"
                                     LexBuffer<char>.LexemeString lexbuf 
# 30 "./Assignement2/HelloLex/hello2.fs"
          )
  | 1 -> ( 
# 10 "./Assignement2/HelloLex/hello2.fsl"
                                     failwith "Lexer error: illegal symbol" 
# 35 "./Assignement2/HelloLex/hello2.fs"
          )
  | _ -> failwith "Tokenize"

# 13 "./Assignement2/HelloLex/hello2.fsl"
  // ending
...
# 52 "./Assignement2/HelloLex/hello2.fs"
# 3000000 "./Assignement2/HelloLex/hello2.fs"
